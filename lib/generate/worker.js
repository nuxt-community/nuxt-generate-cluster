...
export default class Worker extends Hookable() {
  ...
  setStaticAssetsVars () {
    if (this.generator.isFullStatic) {
      const { staticAssets } = this.options.generate
      this.generator.staticAssetsDir = resolve(this.generator.distNuxtPath, staticAssets.dir, staticAssets.version)
      this.generator.staticAssetsBase = staticAssets.versionBase
    }
  }
}
